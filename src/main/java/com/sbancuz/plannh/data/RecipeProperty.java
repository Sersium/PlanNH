...
public class RecipeProperty<T> {
    ...
    public RecipeProperty(String key, String displayName, T defaultValue,
                          BiConsumer<JsonObject, T> serializer,
